    ...
    const openModal = (e) => {
        ...
        if (typeof window.gtag === 'function') {
            window.gtag('event', 'generate_lead', {
                ...
                cta_id: buttonId,
                form_url: 'https://forms.gle/omAbHotDH2WL6Hg28'
            });
            console.log(`[Google Analytics] Tracked audit booking click on button: ${buttonId}`);
        }

        window.open('https://forms.gle/omAbHotDH2WL6Hg28', '_blank');
    };
...
(function() {
    ...
    function loadAnalytics() {
        ...
        if (!window.gtag && !document.querySelector('script[src*="googletagmanager.com/gtag"]')) {
            ...
            console.log('[Lazy Analytics] Google Analytics dynamically loaded on user interaction.');
        }
        ...
        if (!window.fbq && !document.querySelector('script[src*="connect.facebook.net"]')) {
            ...
            console.log('[Lazy Analytics] Facebook Pixel dynamically loaded on user interaction.');
        }
